      ...
      <div className='d-flex flex-column h-100 w-100 align-items-center justify-content-center mx-auto mt-5 '>
        <nav>
          <div className="nav nav-tabs " id="nav-tab" role="tablist">
            <button className="nav-link custom active" style={buttonStyle} id="nav-horarios-tab" data-bs-toggle="tab" data-bs-target="#nav-horarios" type="button" role="tab" aria-controls="nav-horarios" aria-selected="true">Horarios</button>
            <button className="nav-link custom" style={buttonStyle} id="nav-dimensiones-tab" data-bs-toggle="tab" data-bs-target="#nav-dimensiones" type="button" role="tab" aria-controls="nav-dimensiones" aria-selected="false">Dimensiones</button>
            <button className="nav-link custom" style={buttonStyle} id="nav-implementos-tab" data-bs-toggle="tab" data-bs-target="#nav-implementos" type="button" role="tab" aria-controls="nav-implementos" aria-selected="false">Implementos</button>
          </div>
        </nav>
        <div className="h-100 w-100 tab-content mt-4 m-auto" id="nav-tabContent">
          <div className="tab-pane fade show active" id="nav-horarios" role="tabpanel" aria-labelledby="nav-horarios-tab" tabindex="0">
          ...
          <div className="tab-pane fade m-auto" id="nav-dimensiones" role="tabpanel" aria-labelledby="nav-dimensiones-tab" tabindex="0">
            <div className='d-flex flex-column align-items-center justify-content-center mx-auto'>
          ...
          <div className="tab-pane fade m-auto" id="nav-implementos" role="tabpanel" aria-labelledby="nav-implementos-tab" tabindex="0">
            <div className='d-flex flex-column align-items-center justify-content-center mx-auto'>
