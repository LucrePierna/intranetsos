        ...
        <div className="tab-pane fade" id="nav-etapas" role="tabpanel" aria-labelledby="nav-etapas-tab" tabindex="0">
          ...
          <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade px-3 mt-3" id="nav-parking" role="tabpanel" aria-labelledby="nav-parking-tab" tabindex="0">
              <p>Para la coordinación del traslado de la unidad en garantía, el vehículo no tiene que estar en parking. Cliente debe sacar de esa situación el vehículo (parking). Se le recomienda a cliente llamar al concesionario (se puede ayudar a cliente verificando el número de nuestro listado de concesionarios autorizados más próximo y/o transferir el llamado).   </p>
            </div>
