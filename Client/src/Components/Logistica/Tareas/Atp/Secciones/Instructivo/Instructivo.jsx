    ...
    <div className='conteinerNav mt-5'>
      ...
      <div className='h-100 w-100 tab-content text-start mt-3 px-5 m-auto' id="nav-tabContent">
        ...
        <div className="tab-pane fade lineaGeneral" id="nav-cierrechat" role="tabpanel" aria-labelledby="nav-cierrechat-tab" tabIndex="0">
          <h1><u>Confirmar cierre y comprensión de las partes</u></h1>
          ...
          <h1><u>Registrar datos en el servicio</u></h1>
