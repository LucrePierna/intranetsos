    ...
    <div className='conteinerNav mt-5 ' >
      ...
      <div className="tab-content px-5" id="nav-tabContent">
        ...
        <div className="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab" tabindex="0">
          <p>Detectar el motivo de la consulta del prestador, verificar desde que base se está comunicando y cuál es el motivo del contacto. <br />
            Se deberá consultar el código del servicio y a que fecha corresponde. </p>
          <h5>Motivos de Contacto</h5>
        ...
        <div className="tab-pane fade" id="nav-cierrechat" role="tabpanel" aria-labelledby="nav-cierrechat-tab" tabIndex="0">
          <h5>Confirmar cierre y comprensión de las partes</h5>
          ...
          <h5>Registrar datos en el servicio</h5>
