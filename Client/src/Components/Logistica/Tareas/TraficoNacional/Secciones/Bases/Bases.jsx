    ...
    <div className='d-flex align-items-start flex-colum justify-content-center mx-auto h-50 w-50 mt-5'>
      ...
      <div class="tab-content" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-bahia" role="tabpanel" aria-labelledby="nav-bahia-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-orgznbb-tab" data-bs-toggle="tab" data-bs-target="#nav-orgznbb" type="button" role="tab" aria-controls="nav-orgznbb" aria-selected="true">Organización de la Zona</button>
              <button class="nav-link" id="nav-consultabb-tab" data-bs-toggle="tab" data-bs-target="#nav-consultabb" type="button" role="tab" aria-controls="nav-consultabb" aria-selected="false">Consideraciones Generales</button>
              <button class="nav-link" id="nav-inducbb-tab" data-bs-toggle="tab" data-bs-target="#nav-inducbb" type="button" role="tab" aria-controls="nav-inducbb" aria-selected="false">Zona de Induccion</button>
              <button class="nav-link" id="nav-dificilbb-tab" data-bs-toggle="tab" data-bs-target="#nav-dificilbb" type="button" role="tab" aria-controls="nav-dificilbb" aria-selected="false">Zona de Dificil Acceso</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-costa" role="tabpanel" aria-labelledby="nav-costa-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-orgzncosta-tab" data-bs-toggle="tab" data-bs-target="#nav-orgzncosta" type="button" role="tab" aria-controls="nav-orgzncosta" aria-selected="true">Subdivision de la Zona</button>
              <button class="nav-link" id="nav-automaticosta-tab" data-bs-toggle="tab" data-bs-target="#nav-automaticosta" type="button" role="tab" aria-controls="nav-automaticosta" aria-selected="false">Zona en Automatico</button>
              <button class="nav-link" id="nav-induccosta-tab" data-bs-toggle="tab" data-bs-target="#nav-induccosta" type="button" role="tab" aria-controls="nav-induccosta" aria-selected="false">Zonas de Inducción</button>
              <button class="nav-link" id="nav-particularidadcosta-tab" data-bs-toggle="tab" data-bs-target="#nav-particularidadcosta" type="button" role="tab" aria-controls="nav-particularidadcosta" aria-selected="false">Particularidades del Tráfico</button>
              <button class="nav-link" id="nav-dificilcosta-tab" data-bs-toggle="tab" data-bs-target="#nav-dificilcosta" type="button" role="tab" aria-controls="nav-dificilcosta" aria-selected="false">Zonas de Dificil Acceso</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-cuyo" role="tabpanel" aria-labelledby="nav-cuyo-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-orgzncuyo-tab" data-bs-toggle="tab" data-bs-target="#nav-orgzncuyo" type="button" role="tab" aria-controls="nav-orgzncuyo" aria-selected="true">Organización de la Base</button>
              <button class="nav-link" id="nav-automaticuyo-tab" data-bs-toggle="tab" data-bs-target="#nav-automaticuyo" type="button" role="tab" aria-controls="nav-automaticuyo" aria-selected="false">Zonas en Automatico</button>
              <button class="nav-link" id="nav-induccuyo-tab" data-bs-toggle="tab" data-bs-target="#nav-induccuyo" type="button" role="tab" aria-controls="nav-induccuyo" aria-selected="false">Zonas de Inducción</button>
              <button class="nav-link" id="nav-particmza-tab" data-bs-toggle="tab" data-bs-target="#nav-particmza" type="button" role="tab" aria-controls="nav-particmza" aria-selected="false">Particularidades en Mendoza</button>
              <button class="nav-link" id="nav-particsj-tab" data-bs-toggle="tab" data-bs-target="#nav-particsj" type="button" role="tab" aria-controls="nav-particsj" aria-selected="false">Particularidades en San Juan</button>
              <button class="nav-link" id="nav-fronterizocuyo-tab" data-bs-toggle="tab" data-bs-target="#nav-fronterizocuyo" type="button" role="tab" aria-controls="nav-fronterizocuyo" aria-selected="false">Pasos Fronterizos</button>
              <button class="nav-link" id="nav-dificilcuyo-tab" data-bs-toggle="tab" data-bs-target="#nav-dificilcuyo" type="button" role="tab" aria-controls="nav-dificilcuyo" aria-selected="false">Zonas de Dificil Acceso</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-noa" role="tabpanel" aria-labelledby="nav-noa-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-orgznnoa-tab" data-bs-toggle="tab" data-bs-target="#nav-orgznnoa" type="button" role="tab" aria-controls="nav-orgznnoa" aria-selected="true">Organización de la Base</button>
              <button class="nav-link" id="nav-vaciosnoa-tab" data-bs-toggle="tab" data-bs-target="#nav-vaciosnoa" type="button" role="tab" aria-controls="nav-vaciosnoa" aria-selected="false">Servicios con KM Vacios</button>
              <button class="nav-link" id="nav-considnoa-tab" data-bs-toggle="tab" data-bs-target="#nav-considnoa" type="button" role="tab" aria-controls="nav-considnoa" aria-selected="false">Consideraciones Generales</button>
              <button class="nav-link" id="nav-tucumannoa-tab" data-bs-toggle="tab" data-bs-target="#nav-tucumannoa" type="button" role="tab" aria-controls="nav-tucumannoa" aria-selected="false">Tucuman</button>
              <button class="nav-link" id="nav-saltanoa-tab" data-bs-toggle="tab" data-bs-target="#nav-saltanoa" type="button" role="tab" aria-controls="nav-saltanoa" aria-selected="false">Salta</button>
              <button class="nav-link" id="nav-jujuynoa-tab" data-bs-toggle="tab" data-bs-target="#nav-jujuynoa" type="button" role="tab" aria-controls="nav-jujuynoa" aria-selected="false">Jujuy</button>
              <button class="nav-link" id="nav-inducnoa-tab" data-bs-toggle="tab" data-bs-target="#nav-inducnoa" type="button" role="tab" aria-controls="nav-inducnoa" aria-selected="false">Zonas de Inducción</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-patagonia" role="tabpanel" aria-labelledby="nav-patagonia-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-divpat-tab" data-bs-toggle="tab" data-bs-target="#nav-divpat" type="button" role="tab" aria-controls="nav-divpat" aria-selected="true">Subdivisión de Zonas</button>
              <button class="nav-link" id="nav-autopat-tab" data-bs-toggle="tab" data-bs-target="#nav-autopat" type="button" role="tab" aria-controls="nav-autopat" aria-selected="false">Zona en Automatico</button>
              <button class="nav-link" id="nav-inducpat-tab" data-bs-toggle="tab" data-bs-target="#nav-inducpat" type="button" role="tab" aria-controls="nav-inducpat" aria-selected="false">Zonas de Inducción</button>
              <button class="nav-link" id="nav-dificilpat-tab" data-bs-toggle="tab" data-bs-target="#nav-dificilpat" type="button" role="tab" aria-controls="nav-dificilpat" aria-selected="false">Zonas de Dificil Acceso</button>
              <button class="nav-link" id="nav-particpat-tab" data-bs-toggle="tab" data-bs-target="#nav-particpat" type="button" role="tab" aria-controls="nav-particpat" aria-selected="false">Particularidades del Tráfico</button>
              <button class="nav-link" id="nav-fronterapat-tab" data-bs-toggle="tab" data-bs-target="#nav-fronterapat" type="button" role="tab" aria-controls="nav-fronterapat" aria-selected="false">Pasos Fronterizos</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="nav-stafe" role="tabpanel" aria-labelledby="nav-stafe-tab" tabindex="0">
          <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link active" id="nav-orgznstafe-tab" data-bs-toggle="tab" data-bs-target="#nav-orgznstafe" type="button" role="tab" aria-controls="nav-orgznstafe" aria-selected="true">Subdivision de la Zona</button>
              <button class="nav-link" id="nav-automatistafe-tab" data-bs-toggle="tab" data-bs-target="#nav-automatistafe" type="button" role="tab" aria-controls="nav-automatistafe" aria-selected="false">Zona en Automatico</button>
              <button class="nav-link" id="nav-particstafe-tab" data-bs-toggle="tab" data-bs-target="#nav-particstafe" type="button" role="tab" aria-controls="nav-particstafe" aria-selected="false">Particularidades de la Zona</button>
              <button class="nav-link" id="nav-interstafe-tab" data-bs-toggle="tab" data-bs-target="#nav-interstafe" type="button" role="tab" aria-controls="nav-interstafe" aria-selected="false">Servicios Interprovinciales</button>
            </div>
          </nav>
          <div class="tab-content" id="nav-tabContent">
