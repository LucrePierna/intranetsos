    ...
    <div className='d-flex align-items-start flex-colum justify-content-center mx-auto h-50 w-50 mt-5'>
      <nav className='d-flex align-items-start flex-colum'>
        <div className="nav flex-column nav-tabs me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
          <button className="nav-link active" id="nav-orderiv-tab" data-bs-toggle="tab" data-bs-target="#nav-orderiv" type="button" role="tab" aria-controls="nav-orderiv" aria-selected="true">Orden de la Derivación</button>
          <button className="nav-link" id="nav-acepyrech-tab" data-bs-toggle="tab" data-bs-target="#nav-acepyrech" type="button" role="tab" aria-controls="nav-acepyrech" aria-selected="false">Aceptación y Rechazos de Servicios</button>
          <button className="nav-link" id="nav-prioricoord-tab" data-bs-toggle="tab" data-bs-target="#nav-prioricoord" type="button" role="tab" aria-controls="nav-prioricoord" aria-selected="false">Prioridades Para la Coordinación</button>
          <button className="nav-link" id="nav-altbajmov-tab" data-bs-toggle="tab" data-bs-target="#nav-altbajmov" type="button" role="tab" aria-controls="nav-altbajmov" aria-selected="false">Alta y Baja de Móviles</button>
          <button className="nav-link" id="nav-prioriasig-tab" data-bs-toggle="tab" data-bs-target="#nav-prioriasig" type="button" role="tab" aria-controls="nav-prioriasig" aria-selected="false">Prioridad de Asignación</button>
          <button className="nav-link" id="nav-asigautman-tab" data-bs-toggle="tab" data-bs-target="#nav-asigautman" type="button" role="tab" aria-controls="nav-asigautman" aria-selected="false">Asignación Automatica/Manual</button>
          <button className="nav-link" id="nav-contyseg-tab" data-bs-toggle="tab" data-bs-target="#nav-contyseg" type="button" role="tab" aria-controls="nav-contyseg" aria-selected="false">Contención y Seguimiento</button>
          ...
          <button className="nav-link" id="nav-llgdayfin-tab" data-bs-toggle="tab" data-bs-target="#nav-llgdayfin" type="button" role="tab" aria-controls="nav-llgdayfin" aria-selected="false">Control de Llegada y Finalización del Servicio</button>
          ...
          <button className="nav-link" id="nav-inducciones-tab" data-bs-toggle="tab" data-bs-target="#nav-inducciones" type="button" role="tab" aria-controls="nav-inducciones" aria-selected="false">Inducciones</button>
          <button className="nav-link" id="nav-cttomovyprest-tab" data-bs-toggle="tab" data-bs-target="#nav-cttomovyprest" type="button" role="tab" aria-controls="nav-cttomovyprest" aria-selected="false">Contacto con los Móviles o Prestadores</button>
      ...
      <div className="tab-content" id="nav-tabContent">
        <div className="tab-pane fade show active w-50 h-50 m-auto mt-5" id="nav-orderiv" role="tabpanel" aria-labelledby="nav-orderiv-tab" tabindex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-acepyrech" role="tabpanel" aria-labelledby="nav-acepyrech-tab" tabindex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-prioricoord" role="tabpanel" aria-labelledby="nav-prioricoord-tab" tabIndex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-altbajmov" role="tabpanel" aria-labelledby="nav-altbajmov-tab" tabindex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-prioriasig" role="tabpanel" aria-labelledby="nav-prioriasig-tab" tabindex="0">
          <p>
            La prioridad de asignación estará dada por el tipo de contrato que tenga el móvil. No obstante, se deberá tener en cuenta equiparar la cantidad de servicios entre todos los móviles que tengamos trabajando para evitar tener activos que no realicen ni uno solo.
            <li>Contratados fijos;  </li>
            <li>Propios;  </li>
            <li>Eventuales. </li>
          </p>
        </div>
        <div className="tab-pane fade" id="nav-asigautman" role="tabpanel" aria-labelledby="nav-asigautman-tab" tabindex="0">
          <p>
            ...
            <br></br>
            Siempre la prioridad es atender al cliente en la menor demora posible motivo por el cual el paso de asignación automática a manual debe fundarse solo en variables que beneficien la coordinación del servicio.
          </p>
        </div>
        <div className="tab-pane fade" id="nav-contyseg" role="tabpanel" aria-labelledby="nav-contyseg-tab" tabindex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-llgdayfin" role="tabpanel" aria-labelledby="nav-llgdayfin-tab" tabIndex="0">
          <p>
            Es responsabilidad del operador controlar llegadas cuando se cumple el tiempo informado por el móvil y luego proceder con las finalizaciones de los servicios teniendo en cuenta lo siguiente:
        ...
        <div className="tab-pane fade" id="nav-atprest" role="tabpanel" aria-labelledby="nav-atprest-tab" tabindex="0">
          <p> Se designarán operadores para realizar la tarea de ATP, deberán loguearse con un interno especifico que se encuentre habilitado para recibir las llamadas correspondientes.
            <br></br>
            Entre las tareas correspondientes, se detallan las siguientes:
        ...
        <div className="tab-pane fade" id="nav-inducciones" role="tabpanel" aria-labelledby="nav-inducciones-tab" tabindex="0">
          <p>
        ...
        <div className="tab-pane fade" id="nav-cttomovyprest" role="tabpanel" aria-labelledby="nav-cttomovyprest-tab" tabindex="0">
          <p>
            Los medios de comunicación entre los prestadores y los Operadores de Tráfico son:
            <li>Llamada telefónica por Mitrol;  </li>
            <li>Servicio de mensajería habilitado. </li>
          </p>
        </div>
        <div className="tab-pane fade" id="nav-inyfinturn" role="tabpanel" aria-labelledby="nav-inyfinturn-tab" tabindex="0">
          <p>
            Tanto al inicio como al final del día los Operadores de Tráfico deberán:
