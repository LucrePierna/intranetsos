...
export default function Flujograma() {
  return (
    <div className='conteiner-flujograma'>
      ...
      <div className='mt-3'>
        <button> <a target='blank' href="https://redsos-my.sharepoint.com/personal/framirez_redsos_com_ar/_layouts/15/Doc.aspx?sourcedoc={a9380e98-7c70-4f26-a08f-43d8ae3ccd5a}&amp;action=embedview">Vista</a></button>
      </div>
    </div>
  )
}
