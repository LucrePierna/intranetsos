            ...
            <div className="tab-content px-3 m-auto h-50 w-70 fs-5 " id="nav-tabContent">
                ...
                <div className="tab-pane fade px-3 mt-3 text-start" id="nav-extraccion" role="tabpanel" aria-labelledby="nav-extraccion-tab" tabindex="0">
                    ...
                    <div class="tab-content px-3 mt-3 " id="nav-tabContent">
                        ...
                        <p>El operador deberá en primera instancia validar si según la cobertura el cliente posee el servicio. <br/>
                        <u>Luego se deberá corroborar:</u></p>
                ...
                <div className="tab-pane fade px-3 mt-3 text-start" id="nav-cristales" role="tabpanel" aria-labelledby="nav-cristales-tab" tabindex="0">
                    ...
                    <div class="tab-content px-3 mt-3 " id="nav-tabContent">
                        ...
                        <p className='mt-2'><u>Capital Federal y Gran Buenos Aires</u> <br/> 
                        el cliente deberá contactarse con nuestro prestador para pedir turno. Si el cliente rechaza realizar el servicio con alguno de nuestros prestadores se brindará el servicio por reintegro.</p>
