...
export default function Flujograma() {
  return (
    <div className='conteinerFlujograma'>
      ...
      <div className='mt-3'>
      <a target='blank' href="https://redsos-my.sharepoint.com/personal/lugomez_redsos_com_ar/_layouts/15/Doc.aspx?sourcedoc={c9f803dc-1971-4ca1-936a-f8b7ba27cc84}&action=embedview"> <button type='button' class="btn btn-danger mt-3">Acceso</button></a>
      </div>
    </div>
  );
}
