...
export default function MicroStrategy() {
  return (
    <div className='d-flex flex-column justify-contente-center mt-5'>
      ...
      <a href="http://cba-mstr02:8080/MicroStrategy/servlet/mstrWeb?evt=3186&src=mstrWeb.3186&subscriptionID=8C6D331949623CB6CE573F818C42E8E6&Server=CBA-MSTR02&Project=SOS%20BI&Port=0&share=1" target='_blank'><button>MICROSTRATEGY</button></a>
