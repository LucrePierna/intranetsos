...
export default function Flujograma() {
  return (
    ...
    <div>
      <iframe
        src="https://redsos-my.sharepoint.com/:u:/r/personal/lgalindez_redsos_com_ar/_layouts/15/Doc.aspx?sourcedoc=%7Bd3410994-8a45-467f-a83e-6ade6fbb2933%7D&amp=&action=embedview" width="800px" height="500px" frameborder="0">Esto es un documento de
